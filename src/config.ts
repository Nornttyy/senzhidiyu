...
export const CONFIG = {
  ...
  world: {
    chunkSizeM: 16,
    activeChunkRadius: 2, // 玩家周围常驻 5×5 区块，离开后自动卸载未修改资源
    starterChunkMin: 0,
    starterChunkMax: 2, // 出生地 0..47m 保留手工布局，不叠加程序资源
  },
  ...
  phantom: {
    ...
    ringMin: 10, ringMax: 18, leashM: 30, spawn: { x: 32, y: 32 },
  },
  ...
  place: { rangeM: 3, spacingM: 0.8 },
  generation: {
    treeMin: 1, treeMax: 3,
    oreChance: 0.72, secondOreChance: 0.18,
    paddingM: 1.4, nodeSpacingM: 2.3,
  },
  growth: { durS: 90 },
  ...
  sizes: { campfireH: 1.3, postH: 2.2, phantomH: 1.8, torchH: 1.05, stoneH: 1.45 }, // 米（树/矿高度见 tiers）
  handmade: {
